...
import com.surrussent.pokemon.Adapter.TypeSx1Adapter.MyViewHolder
import com.surrussent.pokemon.R
import org.json.JSONArray
import org.json.JSONException
import org.json.JSONObject

class TypeSx1Adapter(// Initialize Adapter variable
    private val mContext: Context, private val mData: JSONArray, private val mColors: JSONObject
) :
    RecyclerView.Adapter<MyViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        // Set recyclerview layout
        val view = LayoutInflater.from(mContext).inflate(R.layout.recycler_strong_x1, parent, false)
